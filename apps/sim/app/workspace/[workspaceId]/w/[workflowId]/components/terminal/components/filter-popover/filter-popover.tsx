  ...
  return (
    <Popover open={open} onOpenChange={onOpenChange} size='sm'>
      ...
      <PopoverContent
        ...
        maxHeight={300}
      >
        <PopoverSection>{tI18n('status')}</PopoverSection>
        <PopoverItem
        ...
        >
          ...
          <span className='flex-1'>{tI18n('error')}</span>
        </PopoverItem>
        <PopoverItem
        ...
        >
          ...
          />
          <span className='flex-1'>{tI18n('info')}</span>
        </PopoverItem>

        {uniqueBlocks.length > 0 && (
          <>
            <PopoverDivider className='my-1' />
            <PopoverSection className='!mt-0'>{tI18n('blocks')}</PopoverSection>

...
[Zendesk](https://www.zendesk.com/)は、強力なツールとAPIを通じて組織がサポートチケット、ユーザー、組織を効率的に管理できるようにする、主要なカスタマーサービスおよびサポートプラットフォームです。AACFlowにおけるZendesk統合により、エージェントは主要なサポート操作を自動化し、サポートデータをワークフローの残りの部分と同期させることができます。

AACFlowでZendeskを使用すると、以下のことが可能です：

...
AACFlow 企业版为需要更高安全性、合规性和管理能力的组织提供高级功能。

---

## 自带密钥（BYOK）

使用您自己的 API 密钥对接 AI 模型服务商，而不是使用 AACFlow 托管的密钥。
...
配置后，工作流将使用您的密钥而非 AACFlow 托管密钥。如移除，工作流会自动切换回托管密钥。
...
<Callout type="warn">
  BYOK 仅适用于托管版 AACFlow。自托管部署需通过环境变量直接配置 AI 提供商密钥。
</Callout>

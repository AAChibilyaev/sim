...
Il vous suffit de télécharger vos documents pour commencer. AACFlow les traite automatiquement en arrière-plan, extrayant le texte, créant des embeddings et les divisant en segments consultables.
...
Pour les documents PDF, AACFlow offre des capacités de traitement améliorées :
...
AACFlow utilise la recherche vectorielle propulsée par [pgvector](https://github.com/pgvector/pgvector) pour comprendre le sens et le contexte de votre contenu :

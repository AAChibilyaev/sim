...
Les webhooks permettent aux services externes de déclencher l'exécution de flux de travail en envoyant des requêtes HTTP à votre workflow. AACFlow prend en charge deux approches pour les déclencheurs basés sur les webhooks.

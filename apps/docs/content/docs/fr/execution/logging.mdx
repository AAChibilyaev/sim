...
AACFlow fournit une journalisation complète pour toutes les exécutions de flux de travail, vous donnant une visibilité totale sur le fonctionnement de vos flux, les données qui les traversent et les éventuels problèmes.

## Système de journalisation

AACFlow propose deux interfaces de journalisation complémentaires pour s'adapter à différents flux de travail et cas d'utilisation :

...
Les connexions sont les voies qui permettent aux données de circuler entre les blocs dans votre flux de travail. Dans AACFlow, les connexions définissent comment l'information passe d'un bloc à un autre, permettant ainsi le flux de données à travers votre flux de travail.

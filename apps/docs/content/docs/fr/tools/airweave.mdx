...
Dans AACFlow, l'intégration Airweave permet à vos agents de rechercher, résumer et extraire des informations de toutes les données de votre organisation via un seul outil. Utilisez Airweave pour favoriser une récupération de connaissances riche et contextuelle au sein de vos flux de travail, que ce soit pour répondre à des questions, générer des résumés ou soutenir une prise de décision dynamique.
{/* MANUAL-CONTENT-END */}

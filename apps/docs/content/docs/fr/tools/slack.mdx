...
<iframe
  ...
  title="Intégration de Slack avec AACFlow"
  frameBorder="0"
...
- **Automatisez les notifications des agents** : Envoyez des mises à jour en temps réel depuis vos agents AACFlow vers n'importe quel canal Slack
- **Créez des points de terminaison webhook** : Configurez des bots Slack comme webhooks pour déclencher des workflows AACFlow à partir des activités Slack
...
Dans AACFlow, l'intégration Slack permet à vos agents d'interagir programmatiquement avec Slack avec des capacités complètes de gestion des messages dans le cadre de leurs workflows :

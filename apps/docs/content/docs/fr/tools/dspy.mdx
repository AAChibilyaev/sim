...
Avec DSPy dans AACFlow, vous pouvez :
...
- **Intégrer à vos workflows** : automatisez les prédictions et le raisonnement LLM dans le cadre de toute automatisation ou routine d'agent AACFlow.
...
Ces fonctionnalités permettent à vos agents AACFlow d'accéder à des programmes modulaires et interprétables basés sur des LLM pour des tâches telles que la réponse aux questions, l'analyse de documents, l'aide à la décision, et plus encore — où vous gardez le contrôle du modèle, des données et de la logique.
{/* MANUAL-CONTENT-END */}

...
L'outil **Recherche** vous permet de rechercher sur le web depuis vos flux de travail AACFlow en utilisant des moteurs de recherche à la pointe de la technologie. Utilisez-le pour intégrer les dernières informations, actualités, faits et contenus web directement dans vos agents, automatisations ou conversations.

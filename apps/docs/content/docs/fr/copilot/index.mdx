...
Copilot est votre assistant intégré à l'éditeur qui vous aide à créer et à modifier des flux de travail avec AACFlow Copilot, ainsi qu'à les comprendre et à les améliorer. Il peut :

- **Expliquer** : répondre aux questions sur AACFlow et votre flux de travail actuel
...
<Callout type="info">
  Copilot est un service géré par AACFlow. Pour les déploiements auto-hébergés, générez une clé API Copilot dans l'application hébergée (aacflow.io → Paramètres → Copilot)
  1. Allez sur [aacflow.io](https://aacflow.io) → Paramètres → Copilot et générez une clé API Copilot
...
- **Documentation** : référencer la documentation de AACFlow

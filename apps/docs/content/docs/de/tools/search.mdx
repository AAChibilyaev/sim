...
Das **Suche**-Tool ermöglicht es dir, das Web innerhalb deiner AACFlow-Workflows mit hochmodernen Suchmaschinen zu durchsuchen. Nutze es, um die neuesten Informationen, Nachrichten, Fakten und Webinhalte direkt in deine Agenten, Automatisierungen oder Gespräche einzubinden.

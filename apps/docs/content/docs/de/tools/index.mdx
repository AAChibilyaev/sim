...
Tools sind leistungsstarke komponenten in AACFlow, die es ihren workflows ermöglichen, mit externen diensten zu interagieren, daten zu verarbeiten und spezialisierte aufgaben auszuführen. Sie erweitern die fähigkeiten ihrer agenten und workflows, indem sie zugang zu verschiedenen APIs und diensten bieten.
...
Es gibt zwei Hauptmöglichkeiten, Tools in Ihren AACFlow-Workflows zu verwenden:
...
AACFlow bietet eine vielfältige Sammlung von Tools für verschiedene Zwecke, darunter:

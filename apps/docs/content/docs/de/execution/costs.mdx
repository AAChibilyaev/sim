...
AACFlow berechnet automatisch die Kosten für alle Workflow-Ausführungen und bietet transparente Preise basierend auf der Nutzung von KI-Modellen und Ausführungsgebühren. Das Verständnis dieser Kosten hilft Ihnen, Workflows zu optimieren und Ihr Budget effektiv zu verwalten.
...
<Tabs items={['Hosted Models', 'Bring Your Own API Key']}>
  <Tab>
    **Hosted Models** - AACFlow bietet API-Schlüssel mit einem 1,4-fachen Preismultiplikator für Agent-Blöcke:
...
Wenn Workflows Tool-Blöcke mit den gehosteten API-Schlüsseln von AACFlow verwenden, werden die Kosten pro Operation berechnet. Verwenden Sie Ihre eigenen Schlüssel über BYOK, um direkt an die Anbieter zu zahlen.
...
AACFlow verwendet ein **Basis-Abonnement + Mehrverbrauch**-Abrechnungsmodell:
...
Wenn der nicht abgerechnete Mehrverbrauch 50 $ erreicht, rechnet AACFlow automatisch den gesamten nicht abgerechneten Betrag ab.
...
- Überprüfen Sie Ihre aktuelle Nutzung unter [Einstellungen → Abonnement](https://aacflow.io/settings/subscription)

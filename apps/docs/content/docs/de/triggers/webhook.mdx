...
Webhooks ermöglichen externen Diensten die Ausführung von Workflows durch das Senden von HTTP-Anfragen an Ihren Workflow. AACFlow unterstützt zwei Ansätze für webhook-basierte Auslöser.

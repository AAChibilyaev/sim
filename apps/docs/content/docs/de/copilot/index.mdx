...
Copilot ist dein Assistent im Editor, der dir hilft, Workflows mit AACFlow Copilot zu erstellen und zu bearbeiten sowie diese zu verstehen und zu verbessern. Er kann:

- **Erklären**: Beantwortet Fragen zu AACFlow und deinem aktuellen Workflow
...
<Callout type="info">
  Copilot ist ein von AACFlow verwalteter Dienst. Für selbst gehostete Installationen generiere einen Copilot API-Schlüssel in der gehosteten App (aacflow.io → Einstellungen → Copilot)
  1. Gehe zu [aacflow.io](https://aacflow.io) → Einstellungen → Copilot und generiere einen Copilot API-Schlüssel
...
- **Dokumentation**: Verweise auf AACFlow-Dokumentation

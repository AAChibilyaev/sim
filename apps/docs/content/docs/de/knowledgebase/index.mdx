...
Laden Sie einfach Ihre Dokumente hoch, um zu beginnen. AACFlow verarbeitet sie automatisch im Hintergrund, extrahiert Text, erstellt Embeddings und teilt sie in durchsuchbare Chunks auf.
...
Für PDF-Dokumente bietet AACFlow erweiterte Verarbeitungsfunktionen:
...
AACFlow verwendet Vektorsuche, die von [pgvector](https://github.com/pgvector/pgvector) unterstützt wird, um die Bedeutung und den Kontext Ihrer Inhalte zu verstehen:

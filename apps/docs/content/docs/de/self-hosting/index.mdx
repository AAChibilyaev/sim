---
title: Self-Hosting
description: Stellen Sie AACFlow auf Ihrer eigenen Infrastruktur bereit
---

import { Card, Cards } from 'fumadocs-ui/components/card'
import { Callout } from 'fumadocs-ui/components/callout'

Stellen Sie AACFlow auf Ihrer eigenen Infrastruktur mit Docker oder Kubernetes bereit.

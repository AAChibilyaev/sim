...
# AACFlow Dokumentation

Willkommen bei AACFlow, einem visuellen Workflow-Builder für KI-Anwendungen. Erstellen Sie leistungsstarke KI-Agenten, Automatisierungs-Workflows und Datenverarbeitungs-Pipelines, indem Sie Blöcke auf einer Leinwand verbinden.

## Schnellstart

<Cards>
  <Card title="Einführung" href="/introduction">
    Erfahren Sie, was Sie mit AACFlow erstellen können
  </Card>
...
<Cards>
  ...
  <Card title="SDKs" href="/api-reference">
    AACFlow in Ihre Anwendungen integrieren
  </Card>
</Cards>
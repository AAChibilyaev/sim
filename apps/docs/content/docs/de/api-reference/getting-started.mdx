...
Go to the AACFlow dashboard and navigate to **Settings → AACFlow Keys**, then click **Create**. See [Authentication](/api-reference/authentication) for details on key types.
</Step>

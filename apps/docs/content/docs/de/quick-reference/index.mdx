---
title: Kurzreferenz
description: Wesentliche Aktionen zum Navigieren und Verwenden des AACFlow-Workflow-Editors
---

import { Callout } from 'fumadocs-ui/components/callout'
import { ActionImage, ActionVideo } from '@/components/ui/action-media'

Eine schnelle Übersicht für alltägliche Aktionen im AACFlow-Workflow-Editor. Für Tastaturkürzel siehe [Tastaturkürzel](/keyboard-shortcuts).

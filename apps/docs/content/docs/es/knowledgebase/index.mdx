...
Simplemente carga tus documentos para comenzar. AACFlow los procesa automáticamente en segundo plano, extrayendo texto, creando incrustaciones y dividiéndolos en fragmentos buscables.
...
Para documentos PDF, AACFlow ofrece capacidades de procesamiento mejoradas:
...
AACFlow utiliza búsqueda vectorial impulsada por [pgvector](https://github.com/pgvector/pgvector) para comprender el significado y contexto de tu contenido:

...
AACFlow es un constructor de flujos de trabajo visuales de código abierto para crear e implementar flujos de trabajo de agentes de IA. Diseña sistemas de automatización inteligentes utilizando una interfaz sin código—conecta modelos de IA, bases de datos, APIs y herramientas empresariales a través de un lienzo intuitivo de arrastrar y soltar. Ya sea que estés creando chatbots, automatizando procesos empresariales u orquestando complejos flujos de datos, AACFlow proporciona las herramientas para dar vida a tus flujos de trabajo de IA.

<div className="flex justify-center">
  <Image
    src="/static/introduction.png"
    alt="Lienzo visual de flujos de trabajo de AACFlow"
    width={700}
    height={450}
    className="my-6"
  />
...
AACFlow proporciona integraciones nativas con más de 80 servicios en múltiples categorías:
...
Copiloto responde preguntas sobre AACFlow, explica tus flujos de trabajo y proporciona sugerencias para mejorarlos. Usa el símbolo `@` para hacer referencia a flujos de trabajo, bloques, documentación, conocimiento y registros para obtener asistencia contextual.
...
**Alojado en la nube**  
Comienza inmediatamente en [aacflow.io](https://aacflow.io) con infraestructura totalmente gestionada, escalado automático y observabilidad integrada. Concéntrate en construir flujos de trabajo mientras nosotros nos encargamos de las operaciones.

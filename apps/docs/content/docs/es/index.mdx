...
# Documentación de AACFlow

Bienvenido a AACFlow, un constructor visual de flujos de trabajo para aplicaciones de IA. Crea potentes agentes de IA, flujos de trabajo de automatización y canales de procesamiento de datos conectando bloques en un lienzo.

## Inicio rápido

<Cards>
  <Card title="Introducción" href="/introduction">
    Aprende lo que puedes construir con AACFlow
  </Card>
...
<Cards>
  ...
  <Card title="SDKs" href="/api-reference">
    Integra AACFlow en tus aplicaciones
  </Card>
</Cards>
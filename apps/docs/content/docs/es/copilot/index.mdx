...
Copilot es tu asistente integrado en el editor que te ayuda a crear y editar flujos de trabajo con AACFlow Copilot, así como a entenderlos y mejorarlos. Puede:

- **Explicar**: Responder preguntas sobre AACFlow y tu flujo de trabajo actual
...
<Callout type="info">
  Copilot es un servicio gestionado por AACFlow. Para implementaciones autoalojadas, genera una clave API de Copilot en la aplicación alojada (aacflow.io → Configuración → Copilot)
  1. Ve a [aacflow.io](https://aacflow.io) → Configuración → Copilot y genera una clave API de Copilot
...
- **Documentación**: Referencia la documentación de AACFlow

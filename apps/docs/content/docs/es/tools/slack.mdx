...
<iframe
  ...
  title="Integración de Slack con AACFlow"
  frameBorder="0"
...
- **Automatiza notificaciones de agentes**: Envía actualizaciones en tiempo real desde tus agentes AACFlow a cualquier canal de Slack
- **Crea endpoints de webhook**: Configura bots de Slack como webhooks para activar flujos de trabajo de AACFlow desde actividades de Slack
...
En AACFlow, la integración con Slack permite a tus agentes interactuar programáticamente con Slack con capacidades completas de gestión de mensajes como parte de sus flujos de trabajo:

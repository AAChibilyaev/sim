...
La [API de 1Password Connect](https://developer.1password.com/docs/connect/) permite el acceso programático a bóvedas y elementos dentro de la cuenta de 1Password de una organización. Esta integración en AACFlow te permite automatizar la recuperación de secretos, flujos de trabajo de incorporación, rotación de secretos, auditorías de bóvedas y más, todo de manera segura y auditable.

Con 1Password en tu flujo de trabajo de AACFlow, puedes:

...
Las herramientas son componentes potentes en AACFlow que permiten a tus flujos de trabajo interactuar con servicios externos, procesar datos y realizar tareas especializadas. Amplían las capacidades de tus agentes y flujos de trabajo proporcionando acceso a varias APIs y servicios.
...
Hay dos formas principales de utilizar herramientas en tus flujos de trabajo de AACFlow:
...
AACFlow proporciona una colección diversa de herramientas para varios propósitos, incluyendo:

...
- **Integrar con tus flujos de trabajo**: automatiza predicciones y razonamiento de LLM como parte de cualquier rutina de automatización o agente de AACFlow.
...
Estas características permiten que tus agentes de AACFlow accedan a programas modulares e interpretables basados en LLM para tareas como respuesta a preguntas, análisis de documentos, soporte de decisiones y más, donde tú mantienes el control del modelo, los datos y la lógica.
{/* MANUAL-CONTENT-END */}

...
description: Los disparadores son las formas principales de iniciar flujos de trabajo de AACFlow
---
...
Cuando haces clic en **Ejecutar** en el editor, AACFlow selecciona automáticamente qué disparador ejecutar según el siguiente orden de prioridad:
...
Los invitados reciben un correo electrónico con un enlace para conectar su cuenta. Una vez conectada, su bandeja de entrada se incluye automáticamente en el grupo de sondeo. Los invitados no necesitan ser miembros de tu organización AACFlow.

...
El bloque Inicio es el disparador predeterminado para los flujos de trabajo creados en AACFlow. Recopila entradas estructuradas y se distribuye al resto de tu gráfico para pruebas de editor, implementaciones de API y experiencias de chat.

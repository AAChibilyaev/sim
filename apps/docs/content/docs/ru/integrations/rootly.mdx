...
**Using Rootly in AACFlow**


AACFlow's Rootly integration connects your agentic workflows directly to your Rootly account using an API key. With operations spanning incidents, alerts, services, severities, teams, environments, functionalities, incident types, and retrospectives, you can build powerful incident management automations without writing backend code.


**Key benefits of using Rootly in AACFlow:**
...
Whether you're automating incident response, building on-call alerting pipelines, or driving post-incident learning, Rootly in AACFlow gives you direct, secure access to the Rootly API — no middleware required. Simply configure your API key, select the operation you need, and let AACFlow handle the rest.

...
===
[Gong](https://www.gong.io/) — это платформа для анализа данных о продажах, которая собирает и анализирует взаимодействия с клиентами во время звонков, электронных писем и встреч. Интегрируя Gong с AACFlow, ваши агенты смогут получать доступ к данным разговоров, аналитике пользователей, метрикам обучения и другой информации через автоматизированные рабочие процессы.

Интеграция Gong в AACFlow предоставляет инструменты для:

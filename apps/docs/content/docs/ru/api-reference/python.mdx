...
Официальный SDK для AACFlow позволяет вам программно выполнять рабочие процессы из ваших приложений на Python, используя официальный SDK для Python.
...
client = SimStudioClient(
    ...
    base_url="https://aacflow.io"  # optional, defaults to https://aacflow.io
)
...
```python
SimStudioClient(api_key: str, base_url: str = "https://aacflow.io")
```


**Параметры:**

- `api_key` (str): Ваш ключ API для AACFlow

- `base_url` (str, необязательно): Базовый URL для API AACFlow

...
AACFlow Enterprise добавляет детальный контроль доступа, SSO, аудит-логи и функции соответствия требованиям поверх командных тарифных планов.
...
Replace AACFlow's default branding — logos, product name, and favicons — with your own. See the [whitelabeling guide](/platform/enterprise/whitelabeling).
...
<FAQ items={[
  ...
  { question: "Which SSO providers are supported?", answer: "AACFlow supports SAML 2.0 and OIDC, which works with virtually any enterprise identity provider including Okta, Azure AD (Entra ID), Google Workspace, ADFS, and OneLogin." },

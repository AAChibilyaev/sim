---
title: Whitelabeling
description: Replace AACFlow branding with your own logo, colors, and links
---

import { FAQ } from '@/components/ui/faq'
import { Image } from '@/components/ui/image'

Whitelabeling lets you replace AACFlow's default branding — logo, colors, and support links — with your own. Members of your organization see your brand instead of AACFlow's throughout the workspace.
...
| **Brand name** | Replaces "AACFlow" in the sidebar and select UI elements. Max 64 characters. |
...
Replace AACFlow's default support and legal links with your own.
...
- **Sidebar logo and wordmark** — your uploaded images replace the AACFlow logo
...
<FAQ items={[
  {
    ...
    answer: "Organization owners and admins can configure whitelabeling. On AACFlow Cloud, you must be on the Enterprise plan."
  },
  {

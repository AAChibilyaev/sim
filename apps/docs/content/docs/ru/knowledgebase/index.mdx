...
When you upload a document, AACFlow processes it in the background:
...
AACFlow accepts PDF, Word, text, Markdown, HTML, Excel, PowerPoint, CSV, JSON, and YAML files, up to 100 MB each (best under 50 MB). Scanned PDFs work too: with Azure or [Mistral OCR](https://docs.mistral.ai/ocr/) configured, AACFlow extracts text from image-based pages.
...
<FAQ items={[
  ...
  { question: "Does it support scanned PDFs?", answer: "Yes. With Azure or Mistral OCR configured, AACFlow extracts text from image-based and scanned PDF pages." },

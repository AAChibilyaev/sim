...
description: Essential actions for navigating and using the AACFlow workflow editor
---

import { Callout } from 'fumadocs-ui/components/callout'
import { ActionImage, ActionVideo } from '@/components/ui/action-media'

A quick lookup for everyday actions in the AACFlow workflow editor. For keyboard shortcuts, see [Keyboard Shortcuts](/keyboard-shortcuts).

...
<FAQ items={[
  ...
  { question: "Where is the conversation stored?", answer: "In your AACFlow workspace, as a stored transcript per conversation ID. You can inspect it, and the agent reads from it automatically before each run." },
]} />

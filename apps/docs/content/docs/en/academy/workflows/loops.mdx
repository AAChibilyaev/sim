...
Repeating the same steps across a whole collection is one of the most fundamental ideas in programming. AACFlow gives you two blocks for it: the **Loop** block and the **Parallel** block. They do the same job and differ only in *how* they run.

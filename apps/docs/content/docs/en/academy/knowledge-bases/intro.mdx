...
AACFlow automatically **indexes and embeds** every document into searchable **chunks**, so the contents become queryable by meaning, you don't manage any of that yourself.
...
<FAQ items={[
  { question: "What is a knowledge base in AACFlow?", answer: "A workspace resource that holds your documents processed into searchable chunks, so agents and workflows can retrieve the most relevant passages instead of stuffing whole documents into context." },

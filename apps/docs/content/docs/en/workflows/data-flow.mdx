...
When a block runs, AACFlow keeps its result under the block's name for the rest of the run. That stored result is the block's **output**, and any later block can read it.

...
This pairs naturally with the [AACFlow trigger](/workflows/triggers/sim): the trigger hands you the `runId` that fired the event, and Get Run Details gives you the full trace.

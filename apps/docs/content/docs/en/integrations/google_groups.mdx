...
This page explains how you can use AACFlow to automate the management of Google Groups in your workflows. With AACFlow, agents can create and configure groups, add or remove members, update group settings, and keep directory lists up-to-date automatically—ideal for onboarding workflows, syncing IT systems, or dynamically managing project teams.

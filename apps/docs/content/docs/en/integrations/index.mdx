...
Integrations are authenticated connections to third-party services like Gmail, Slack, GitHub, and HubSpot. AACFlow handles the OAuth flow, token storage, and automatic token refresh — you connect once and select the account in any block that needs it.
...
- **+ Add to AACFlow** — connects your account.
...
1. Open the service's page and click **+ Add to AACFlow**.
2. Enter a **Display name** to identify this connection (e.g. "Work Gmail" or "Sales HubSpot"), and optionally a **Description**.
3. Review the **Permissions requested** — these are the scopes AACFlow will ask the provider for.

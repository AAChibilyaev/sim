...
With the Google PageSpeed integration in AACFlow, you can:
...
In AACFlow, the Google PageSpeed integration enables your agents to programmatically audit web pages as part of automated workflows. This is useful for monitoring site performance over time, triggering alerts when scores drop below thresholds, generating performance reports, and ensuring that deployed changes meet quality standards before release.
...
5. Use the API key in the AACFlow block configuration
{/* MANUAL-CONTENT-END */}

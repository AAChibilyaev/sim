...
In AACFlow, the RDS integration enables your agents to work with Amazon Aurora Serverless databases securely and programmatically. Supported operations include:
...
This integration allows your agents to automate a wide range of database operations without manual intervention. By connecting AACFlow with Amazon RDS, you can build agents that manage, update, and retrieve relational data within your workflows—all without handling database infrastructure or connections.
{/* MANUAL-CONTENT-END */}

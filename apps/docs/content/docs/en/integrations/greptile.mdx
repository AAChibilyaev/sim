...
The AACFlow Greptile integration allows your AI agents to:
...
- Trigger automations in AACFlow workflows based on search/query results or embed code intelligence directly into your processes.

Whether you’re trying to accelerate developer productivity, automate documentation, or supercharge your team’s understanding of a complex codebase, Greptile and AACFlow provide seamless access to code intelligence and search—right where you need it.
{/* MANUAL-CONTENT-END */}

...
| `appSecret` | string | Yes | Required for WhatsApp POST signature verification. AACFlow uses it to validate the X-Hub-Signature-256 header on every webhook delivery. |

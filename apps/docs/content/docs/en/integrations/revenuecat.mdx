...
In AACFlow, the RevenueCat integration allows your agents to fetch and manage subscriber data, review and update entitlements, and automate subscription-related workflows. Use RevenueCat to centralize subscription operations for your apps directly within your AACFlow workspace.
{/* MANUAL-CONTENT-END */}
...
| Parameter | Type | Required | Description |
| --------- | ---- | -------- | ----------- |
| `apiKey` | string | Yes | Secret API key with the project_configuration:integrations:read_write permission. AACFlow uses it to create and remove the webhook in RevenueCat. |

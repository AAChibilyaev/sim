...
<FAQ items={[
  {
    ...
    answer: "Only organization owners and admins can configure data retention settings. On AACFlow Cloud, the organization must be on an Enterprise plan."
  },
  {
...
Once enabled, data retention settings are configurable through **Settings → Enterprise → Data Retention** the same way as AACFlow Cloud.

...
<FAQ items={[
  ...
  { question: "Do I need API keys to follow this tutorial?", answer: "No. On hosted AACFlow, the model and the search tools run on AACFlow's hosted keys, included with your plan credits. You can bring your own provider keys if you prefer." },
